...
<body>
        ...
        <div class="form-container ">
            <form action="actualizadoCP.jsp" method="POST" >
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <label class="form-label" for="genrado">Generado por:</label>
                        <input type="text" class="form-control" id="generado" name="generado" placeholder="" required  value="<% if(u != null) {out.print(u.getEmpleado()); } %>" readonly>
                    </div>
                    <div class="col-md-3">
