...
<body>
        ...
        <div class="form-container ">
            <form action="OculRegistro.jsp" method="POST" >
                <div class="row mb-4">
                    <input type="hidden" name="id" value="<%=pp.getId()%>">
                    <div class="col-md-3">
                        <label class="form-label" for="area_solicitada"></label>
                        <select name="ar" id="ar" class="form-control" required>
                           <%
                                ...
                                for (String cantidad : areas) {
                            %>
                                <option value="<%= cantidad %>" <%= cantidad.equals(areaGuardada) ? "selected" : "" %>>
                                    <%= cantidad %>
                                </option>
                            <% } %>
                        </select>
...
<%
    if (request.getParameter("actualizar") != null) {
            ...
            String cantidad = request.getParameter("ar");
